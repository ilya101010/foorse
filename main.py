...
from database.db_utils import is_db_empty, run_schema_sql, process_html_file, process_excel_file
from utils.file_utils import get_html_files, pick_reference_file, get_excel_files
...
def main():
    ...
    html_files = get_excel_files(directory)
